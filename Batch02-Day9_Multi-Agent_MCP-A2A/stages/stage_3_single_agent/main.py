...
QUESTION = (
    "A tech startup with $5M revenue breached a vendor contract, shared user data "
...
SYSTEM_PROMPT = (
    ...
    "contract breach, case law, and compliance. Keep your final answer under 500 words."
)
